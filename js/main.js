...
//function change_content_holder(){
//    var content = $('#content-holder');
//    var classes = content.attr('class');
//    if (classes.indexOf('6')!=-1)
//        classes = classes.replace(/6/g , '12');
//    else
//        classes = classes.replace(/12/g, '6');
//    for(i = 0 ; i < content.length ; i++)
//        content
//}

function counter_for_supporters(id){
    $('#opponent-comments-area').attr('placeholder','Counter by commenting your views here').focus();
}
function counter_for_opponents(id){
    $('#supporters-comments-area').attr('placeholder','Counter by commenting your views here').focus();
}
function reset_comments_section(){
